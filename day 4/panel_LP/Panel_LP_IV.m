...
% K --> number of units (e.g. countries)
% Inputs:   YY: TxK dependent variable (panel outcome)
%           XX: TxK matrix of regressors OR Tx1 when common across units
...
%           DetermControls: TxNxK 3D matrix of deterministic controls (panel),
%                          can be [] if none
%           Instr:  TxK matrix of instruments OR TxNxK 3D matrix of instruments
%                  OR TxN when common across units
%           a_id:   TxK matrix of unit identifiers (panel structure)
%           a_time: TxK matrix of time identifiers (panel structure)
