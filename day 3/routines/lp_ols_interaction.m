...
%
% Outputs:  res = struct()
%           res.beta = (H+1-hStart)xM coefficients of shocks
%           res.se = (H+1-hStart)xM standard errors of coefficients of shocks
%           res.h = (H+1-hStart)x1 horizons of IRFs
%           res.irf = (H+1-hStart)x1 final IRFs
%           res.se_ir = (H+1-hStart)x1 standard errors of final IRFs
